...
abstract class mod_quiz_attempts_report_form extends moodleform
{
        ...
        protected function standard_attempt_fields(MoodleQuickForm $mform)
        {
                ...
                $mform->addGroup(
                        $stategroup,
                        'stateoptions',
                        get_string('reportattemptsthatare', 'quiz'),
                        array(' '),
                        false
                );
        ...
        public function validation($data, $files)
        {
                ...
                if ($data['attempts'] != quiz_attempts_report::ENROLLED_WITHOUT && !($data['stateinprogress'] || $data['stateoverdue'] || $data['statefinished'] || $data['stateabandoned'])) {
